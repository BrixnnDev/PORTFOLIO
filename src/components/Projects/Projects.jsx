...
const projects = [
  ...
  {
    title: 'Vortex Plus',
    description: 'Plataforma de streaming de contenido multimedia con reproduccion en tiempo real y sistema de suscripciones.',
    tags: ['React', 'Node.js', 'MongoDB'],
    github: '#',
    demo: '#',
    images: [],
    featured: false,
    info: {
      objective: 'Crear una plataforma de streaming moderna y rapida.',
      process: 'Frontend en React con video player custom. Backend con Node.js y MongoDB para gestion de contenido.',
      features: ['Reproduccion en tiempo real', 'Sistema de suscripciones', 'Busqueda avanzada', 'Listas de favoritos'],
      duration: '4 semanas',
      role: 'Full Stack Developer',
    },
  },
